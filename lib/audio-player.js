...
export default class AudioPlayer {
  ...
  /**
   * @param {{ baseDir?: string, device?: string, commandCandidates?: Array<{ command: string, args: string[], buildArgs?: (context: { device: string }) => string[] }> }} [options]
   */
  constructor({ baseDir, device = "", commandCandidates = DEFAULT_COMMAND_CANDIDATES } = {}) {
